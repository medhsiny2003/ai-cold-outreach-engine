...
def generate_fallback_template(
    ...
    if effective_theme == "drones_robotics":
        ...
        th_hr_fr = "automatisme industriel et SCADA"
        ...
        th_hr_fr = "systèmes embarqués et Edge AI"
        ...
        th_hr_fr = "génie électrique et électrotechnique"
